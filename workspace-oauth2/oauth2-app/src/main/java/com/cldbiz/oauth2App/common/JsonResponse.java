package com.cldbiz.oauth2App.common;
...
public class JsonResponse extends HashMap<String, Object> {
	...
	private void setMessage(Map<String, String> validationMsgs) {
		this.put(JsonResponse.MESSAGE_KEY, new Message(validationMsgs));
	}
	...
	public static Builder getBuilder(Map<String, String> validationMsgs) {
		return new Builder(validationMsgs);
	}
	...
	public static class Builder {
		...
		public Builder(Map<String, String> validationMsgs) {
			jsonResponse = new JsonResponse();
			jsonResponse.setMessage(validationMsgs);
		}
